...
export const AboutSection: React.FC = () => {
    return (
        <div id='sobre' className="w-full lg:h-screen flex flex-col lg:flex-row items-center justify-center px-4 md:px-8 lg:px-20 xl:px-40 gap-10 lg:gap-20 lg:py-10 pt-20 md:pt-28">
