...
export const AboutSection: React.FC = () => {
    return (
        <div id='sobre' className="w-full lg:h-screen flex flex-col lg:flex-row items-center justify-center px-4 md:px-8 lg:px-20 xl:px-40 gap-10 lg:gap-20 lg:py-10 lg:pt-40">
            <div className="w-full lg:w-1/2 flex flex-col gap-4 items-center lg:items-center text-center lg:text-left font-bold md:pt-10">
                <h1 className="font-bold text-primary text-3xl sm:text-4xl mt-10 md:mt-0">Dra. Deise Soares</h1>
                <span className="px-4 text-secondary italic text-sm font-bold rounded-full bg-terciary text-center">
                    Biomédica Esteta | Especialista em Harmonização Facial e Corporal
                </span>
                <div className="flex flex-col gap-4 text-primary text-sm lg:text-base sm:text-lg">
