...
export const AboutSection: React.FC = () => {
    return (
        <div className="w-full lg:h-screen flex flex-col lg:flex-row items-center justify-center px-4 md:px-8 lg:px-20 xl:px-40 gap-10 lg:gap-20 lg:py-10">
            <div className="w-full lg:w-1/2 flex flex-col gap-4 items-center lg:items-center text-center lg:text-left">
            ...
            <div className="w-full lg:w-1/2 flex justify-center md:pt-36 lg:pt-72">
                <Image
                    alt="Foto Deise"
                    src={photoAbout}
                    className="w-80 lg:w-full lg:h-auto object-contain"
                    priority
                />
            </div>
        </div>
